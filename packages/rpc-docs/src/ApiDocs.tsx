...
export function ApiDocs({
  ...
  const { filteredProcedures, groups, totalCount, filteredCount } =
    useMemo(() => {
  ...
  if (isLoading) {
    return (
      <div
        className={`api-docs api-docs-loading ${className}`}
  ...
  if (error) {
    return (
      <div
        className={`api-docs api-docs-error ${className}`}
      ...
      {showHeader && (
        <header className="api-docs-header" data-testid="api-docs-header">
          <div className="api-docs-header-content">
            <h2 className="api-docs-title" data-testid="api-docs-title">
              {title}
            </h2>
            <p
              className="api-docs-description"
