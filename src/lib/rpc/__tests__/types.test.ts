...
describe('Type Inference (Compile-Time Verification)', () => {
  ...
  it('should correctly infer input types', () => {
    ...
    const streamEventsInput: StreamEventsInput = undefined as unknown as StreamEventsInput;
  ...
  it('should correctly infer procedure types', () => {
    ...
    type StreamEventsType = InferProcedureType<TestContract['stream']['events']>;
